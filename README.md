...
Health Compass has been developed using [Gemini](https://gemini.google.com/), [Aider](https://aider.chat/), and [GitHub Copilot](https://github.com/features/copilot). The Health Compass logo is generated using [Copliot](https://copilot.microsoft.com/).
